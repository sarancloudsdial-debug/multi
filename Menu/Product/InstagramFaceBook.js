...
import { FaFacebookMessenger, FaInstagram, FaBolt, FaUsers, FaChartLine, FaRobot, } from "react-icons/fa";
...
export default function SocialIntegration() {
  ...
  `;
    ...
    return (_jsxs("div", { className: "social-page", children: [_jsx("style", { children: css }), _jsxs("section", { className: "hero", children: [_jsx(motion.div, { className: "hero-image", initial: { opacity: 0, x: 60 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.8 }, children: _jsx("div", { className: "illustration float", style: { width: '100%' }, children: _jsx("img", { src: hero, alt: "inbox-illustration" }) }) }), _jsxs(motion.div, { className: "hero-copy", initial: { opacity: 0, x: -40 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.8 }, children: [_jsx("h2", { children: "Organize your Instagram & Facebook Messenger DMs & stay connected with your customers 24\u00D77" }), _jsx("p", { className: "lead", children: "One dashboard to manage Multi-channel conversations. Consolidate your customer interactions in one unified view \u2014 manage Instagram and Facebook Messenger messages effortlessly from a single place." }), _jsxs("ul", { className: "benefits-list", children: [_jsxs("li", { children: [_jsx("div", { className: "dot" }), _jsxs("div", { children: [_jsx("div", { className: "benefit-text", children: "Stay organized with conversation filters" }), _jsx("div", { className: "benefit-sub", children: "Assign chats to specific teams or members. Say goodbye to ignored inquiries." })] })] }), _jsxs("li", { children: [_jsx("div", { className: "dot" }), _jsxs("div", { children: [_jsx("div", { className: "benefit-text", children: "Automate responses & capture leads" }), _jsx("div", { className: "benefit-sub", children: "Use quick replies, buttons and forms to capture phone numbers and emails in DMs." })] })] })] }), _jsxs("div", { className: "hero-buttons", children: [_jsx(motion.button, { className: "btn primary", whileHover: { scale: 1.03 }, children: "Start Free Trial" }), _jsx(motion.button, { className: "btn ghost", whileHover: { scale: 1.03 }, children: "See Demo" })] })] })] }), _jsxs("section", { className: "features", children: [_jsx(motion.h3, { initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, style: { textAlign: 'center', marginBottom: 18, fontSize: '1.6rem' }, children: "Powerful features to supercharge messaging" }), _jsx("div", { className: "features-grid", children: features.map((f, idx) => (_jsxs(motion.div, { className: "feature-card", whileHover: { scale: 1.03 }, initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, transition: { delay: idx * 0.08 }, viewport: { once: true }, children: [_jsx("div", { className: "icon-wrapper", children: f.icon }), _jsx("h4", { children: f.title }), _jsx("p", { children: f.desc })] }, idx))) })] }), _jsxs("section", { className: "how-it-works", children: [_jsx(motion.h3, { initial: { opacity: 0, y: 18 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, style: { fontSize: '1.4rem', marginBottom: 12 }, children: "How it works" }), _jsx("div", { className: "steps", children: steps.map((s, i) => (_jsxs(motion.div, { className: "step", initial: { opacity: 0, x: -20 }, whileInView: { opacity: 1, x: 0 }, transition: { delay: i * 0.12 }, viewport: { once: true }, children: [_jsx("div", { className: "num", children: i + 1 }), _jsxs("div", { children: [_jsx("div", { className: "meta", children: s.title }), _jsx("div", { className: "desc", children: s.desc })] })] }, i))) })] }), _jsxs("section", { className: "cta", children: [_jsx(motion.h3, { initial: { opacity: 0, scale: 0.95 }, whileInView: { opacity: 1, scale: 1 }, transition: { duration: 0.6 }, children: "Ready to manage all your social messages in one place?" }), _jsx(motion.p, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.6, delay: 0.12 }, children: "Start a free trial and see how much time your team can save by automating routine replies and centralizing inboxes." }), _jsx(motion.div, { style: { marginTop: 14 }, children: _jsx(motion.button, { className: "btn primary pulse", whileHover: { scale: 1.05 }, children: "Start Free Trial" }) })] })] }));
}
