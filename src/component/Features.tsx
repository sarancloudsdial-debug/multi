  ...
  const features = [
    {
      ...
      icon: <Megaphone size={40} color="#4369B2" />,
    },
    {
      title: "Chatbots",
    ...
    <section style={styles.section}>
      ...
      <div style={styles.container}>
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          Powerful <span style={styles.gradientText}>Features</span>
        </motion.h2>
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Engage customers, automate workflows, and boost sales with our all-in-one solutions.
        </motion.p>
        ...
        <div style={styles.grid}>
          {features.map((feature, i) => (
            ...
            >
              ...
              <motion.h3 style={styles.featureTitle} whileHover={{ scale: 1.08 }}>
                {feature.title}
              </motion.h3>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  backgroundAccent: {
    ...
    background:
      "radial-gradient(circle at 20% 30%, rgba(67,105,178,0.12), transparent 60%), radial-gradient(circle at 80% 70%, rgba(59,130,246,0.15), transparent 50%)",
    zIndex: 0,
  },
  animatedBlob: {
    position: "absolute",
